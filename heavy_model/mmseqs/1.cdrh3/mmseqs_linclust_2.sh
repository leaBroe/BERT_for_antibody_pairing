...
#SBATCH --output=/ibmm_data2/oas_database/paired_lea_tmp/heavy_model/outputs/mmseqs_cdrh3_%j.o
#SBATCH --error=/ibmm_data2/oas_database/paired_lea_tmp/heavy_model/outputs/mmseqs_cdrh3_%j.e
