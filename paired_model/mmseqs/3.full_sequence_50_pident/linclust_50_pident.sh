...
#SBATCH --job-name=mmseqs_full_paired_50
#SBATCH --output=/ibmm_data2/oas_database/paired_lea_tmp/paired_model/mmseqs/logs/mmseqs_50_%j.o
#SBATCH --error=/ibmm_data2/oas_database/paired_lea_tmp/paired_model/mmseqs/logs/mmseqs_50_%j.e
