...
ax.set_title('t-SNE of Last Layer Embeddings Kappa/Lambda Locus FULL data')
...
plt.show()
plt.savefig('/ibmm_data2/oas_database/paired_lea_tmp/paired_model/BERT2BERT/analysis_plots/tsne_heavy2light_FULL_data_fewer_subtypes_2.png')
