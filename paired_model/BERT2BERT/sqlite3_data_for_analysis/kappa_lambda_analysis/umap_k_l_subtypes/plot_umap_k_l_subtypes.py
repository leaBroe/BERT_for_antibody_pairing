...
output_path = f"/ibmm_data2/oas_database/paired_lea_tmp/paired_model/BERT2BERT/analysis_plots/IgBERT2IgBERT/{run_name}/u-map"
...
plt.savefig(f'{output_path}/umap_heavy2light_FULL_data_locus_.png')
# Display the plot
plt.show()
